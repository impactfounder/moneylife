    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-amber-50">
                      ...
                      <th className="border border-gray-300 px-4 py-3 text-left font-semibold">확인 방법</th>
                      <th className="border border-gray-300 px-4 py-3 text-left font-semibold">중요도</th>
                    </tr>
                  </thead>
                  <tbody>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="bg-gradient-to-br from-yellow-500 to-orange-600 text-white p-4 rounded-xl mb-4">
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-amber-50">
                      ...
                      <th className="border border-gray-300 px-4 py-3 text-right font-semibold">현재 (4.5%)</th>
                      <th className="border border-gray-300 px-4 py-3 text-right font-semibold">전환 후 (3.8%)</th>
                      <th className="border border-gray-300 px-4 py-3 text-right font-semibold">절감액</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-3 text-right text-green-700 font-bold">▼ 13만원/월</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-3 text-right text-green-700 font-bold">▼ 210만원/년</td>
                    </tr>
            ...
            <div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-amber-50">
                      <th className="border border-gray-300 px-4 py-3 text-left font-semibold">은행</th>
                      <th className="border border-gray-300 px-4 py-3 text-center font-semibold">기준금리</th>
                      <th className="border border-gray-300 px-4 py-3 text-center font-semibold">최대 우대</th>
                      <th className="border border-gray-300 px-4 py-3 text-center font-semibold">최저 금리</th>
        ...
        <section className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/mortgage-calculator" className="block bg-gray-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
            ...
            <Link href="/loan-calculator" className="block bg-gray-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">🏦</div>
