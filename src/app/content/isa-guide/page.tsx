    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm mb-8">
          <h2 className="text-xl font-bold text-slate-900 mb-6">ISA란?</h2>

          <div className="bg-slate-50 rounded-xl p-4 mb-6">
            <p className="font-semibold text-slate-900 mb-2">Individual Savings Account (개인종합자산관리계좌)</p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-slate-50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-slate-900 mb-1">200~400만원</p>
              <p className="text-sm text-slate-600">비과세 한도 (소득에 따라 차등)</p>
            </div>
            <div className="bg-slate-50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-slate-900 mb-1">9.9%</p>
              <p className="text-sm text-slate-600">분리과세 세율 (한도 초과분)</p>
            </div>
            <div className="bg-slate-50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-slate-900 mb-1">1억원</p>
              <p className="text-sm text-slate-600">연간 납입 한도</p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-slate-200">
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">조건</th>
                </tr>
              </thead>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-slate-200">
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">구분</th>
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">일반형 ISA</th>
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">서민형 ISA</th>
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">농어민 ISA</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="px-4 py-3 font-bold text-slate-900">400만원</td>
                  <td className="px-4 py-3 font-bold text-slate-900">400만원</td>
                </tr>
                <tr className="hover:bg-slate-50">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-slate-200">
                  <th className="px-4 py-3 text-left font-semibold text-slate-700">연 수익</th>
                  <th className="px-4 py-3 text-right font-semibold text-slate-700">ISA (서민형)</th>
                  <th className="px-4 py-3 text-right font-semibold text-slate-700">일반 계좌</th>
                  <th className="px-4 py-3 text-right font-semibold text-slate-700">절세 금액</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                  <td className="px-4 py-3">100만원</td>
                  <td className="px-4 py-3 text-right font-bold text-slate-900">0원</td>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="px-4 py-3 text-right font-bold text-slate-900">9.9만원</td>
                ...
                <tr className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3 text-right font-bold text-slate-900">59.4만원</td>
