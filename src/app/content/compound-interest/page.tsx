        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm mb-8">
          ...
          <div className="bg-slate-50 rounded-xl p-4 mb-6">
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <strong className="text-slate-900"> &ldquo;이자가 이자를 낳는다&rdquo;</strong>는 개념으로, 장기 투자 시 기하급수적 증가 효과.
            </p>
            <div className="bg-white rounded-lg p-4 text-sm">
              <p className="font-semibold mb-2 text-slate-900">단리 vs 복리 예시 (1,000만원 투자, 연 10%, 10년)</p>
              <div className="space-y-1 text-slate-700">
                <p>• <strong>단리:</strong> 1,000만원 + (100만원 × 10년) = 2,000만원</p>
                <p>• <strong>복리:</strong> 1,000만원 × (1.1)^10 = <span className="font-bold text-slate-900">2,594만원</span></p>
                <p className="text-xs text-slate-500 mt-2">→ 복리가 594만원 더 많음!</p>
              </div>
            </div>
          </div>
