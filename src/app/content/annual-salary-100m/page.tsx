      ...
      <main className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="border-2 border-slate-200 bg-slate-50 p-6 rounded-xl">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">➖ 세금 공제</h3>
              <div className="space-y-2">
                <div className="flex justify-between text-slate-700">
                ...
                <div className="border-t-2 border-slate-300 pt-2 mt-2 flex justify-between font-bold text-teal-700">
                  <span>세금 소계</span>
            ...
            <div className="bg-gradient-to-r from-green-100 to-emerald-100 p-6 rounded-xl border-4 border-green-500">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-slate-700 pt-2 border-t-2 border-green-300">
                  <span>총 공제액</span>
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-teal-600 bg-slate-50 p-6 rounded-r-xl">
              <h3 className="font-semibold text-slate-900 mb-3">💸 절세 전략 필수</h3>
              <div className="text-slate-700 text-sm space-y-2">
        ...
        <section className="bg-gradient-to-r from-primary-light to-secondary-light rounded-2xl p-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/content/salary-table" className="block bg-white p-6 rounded-xl hover:shadow-sm border border-slate-200 transition-shadow">
              <div className="text-3xl mb-3">📊</div>
            ...
            <Link href="/content/tax-saving" className="block bg-white p-6 rounded-xl hover:shadow-sm border border-slate-200 transition-shadow">
              <div className="text-3xl mb-3">💸</div>
