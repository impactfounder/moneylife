            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-slate-50">
                  <th className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-left whitespace-nowrap">구분</th>
                  <th className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-left">연금저축</th>
                  <th className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-left">IRP (개인형 퇴직연금)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">가입 대상</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">누구나 가능</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">근로자, 자영업자, 공무원 등</td>
                </tr>
                <tr className="bg-blue-50">
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">세액공제 한도</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-blue-700 font-bold">연 600만원</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-blue-700 font-bold">연 900만원<br />(연금저축 포함)</td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">세액공제율</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">16.5% or 13.2%</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">16.5% or 13.2%</td>
                </tr>
                <tr className="bg-green-50">
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">최대 공제액</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-green-700 font-bold">99만원</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 text-green-700 font-bold">148.5만원</td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">투자 상품</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">펀드, 보험, ETF</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">펀드, ETF, 예금 (원리금보장형 30% 이상)</td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">중도 인출</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">가능 (기타소득세 16.5%)</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">원칙적 불가 (예외 있음)</td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">수령 시기</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">만 55세 이상</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">만 55세 이상</td>
                </tr>
                <tr className="bg-yellow-50">
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3 font-semibold whitespace-nowrap">추천 대상</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">유연한 운용 원함</td>
                  <td className="border border-slate-200 px-2 sm:px-4 py-2 sm:py-3">세액공제 최대화</td>
                </tr>
              </tbody>
            </table>
          </div>
