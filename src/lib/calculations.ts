...
const KOREA_STATISTICS = {
  // 단위: 월 소득 (원)
  // p10: 하위 10%, p99: 상위 1%
  // 출처: 통계청 2024년 임금근로자 소득 데이터
  all: {
    p10: 1500000,
    p25: 2200000,
    p50: 3000000,  // 중위소득 약 300만원 (연 3,600만)
    p75: 4500000,  // 상위 25% 약 450만원 (연 5,400만)
    p90: 7000000,  // 상위 10% 약 700만원 (연 8,400만)
    p95: 9000000,  // 상위 5% 약 900만원 (연 1.08억)
    p99: 15000000  // 상위 1% 약 1,500만원 (연 1.8억)
  },
  seoul: {
    p10: 1800000, p25: 2600000, p50: 3600000, p75: 5500000, p90: 8500000, p95: 11000000, p99: 18000000
  },
  metro: {
    p10: 1600000, p25: 2400000, p50: 3300000, p75: 5000000, p90: 7500000, p95: 10000000, p99: 16000000
  },
  other: {
    p10: 1400000, p25: 2000000, p50: 2700000, p75: 4200000, p90: 6500000, p95: 8500000, p99: 14000000
  }
};
